...
void setup(){
  ...
  v1.Log();  //変数に.をつけて繋げることでクラスの関数を使えます
  
  /*クラスとインスタンスは、設計図とそれを元に作ったものという関係です*/
  Vector3 v2 = new Vector3(2.0, 4.0, 6.0);  //v2はv1とは全く別のインスタンスです
  v2.Log();
  
  v1.Add(v2).Log();  //このように、型さえ合っていればつなげて書くこともできます
  
  /*興味を持った人は『Processingの教科書』で勉強してみましょう*/
}
